...
const DesignElementContextMenu: FunctionComponent<DesignElementContextMenuProps> = (props) => {
  ...
  return (<Toolbar style={{width: '100%'}}>
      <Card style={{ backgroundColor: NeonTheme.palette.background.default}}>
      <CardContent>
        ...
        {
          props.addDesignElement &&            <CardActions style={{ width: "100%", margin:NeonTheme.spacing(0,0,0,0), backgroundColor: NeonFuchsiaHex}}><Grid container item>
            <Grid
              container
              item
              wrap="nowrap"
